...
export default function Support() {
  const [activeTab, setActiveTab] = useState('neues-ticket');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createSupportTicket({ titel, kategorie, nachricht });
      setTitel('');
      setKategorie('allgemein');
      setNachricht('');
      setAbgesendet(true);
    } catch (err) {
      setErrorMsg(err.message || 'Fehler beim Senden der Anfrage.');
    } finally {
      setLoading(false);
    }
  };

  const handleSendAntwort = async (e) => {
    e.preventDefault();
  ...
  return (
    <div className="support-container">
      <div
        ...
        style={{
          maxWidth: activeTab === 'meine-tickets' ? '800px' : '600px',
      ...
      >
        <div className="support-header">
          ...
          <p className="support-subtitle">
            Hast du eine Frage oder ein Problem? Erstelle ein Ticket oder
            verfolge deine bestehenden Anfragen.
          </p>
          ...
          >
            <button
              ...
              style={{
                backgroundColor:
                  activeTab === 'neues-ticket' ? undefined : '#2a2a2a',
            ...
            <button
              ...
              style={{
                backgroundColor:
                  activeTab === 'meine-tickets' ? undefined : '#2a2a2a',
                  ...
                  {tickets.map((t) => (
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor:
                          selectedTicket?.id === t.id ? '#2a2a2a' : '#1a1a1a',
                        cursor: 'pointer',
                        textAlign: 'left',
                      }}
                    >
                      ...
                      >
                        {sortedMessages.map((m) => (
                          <div
                            key={m.id}
                            style={{
                              alignSelf: m.ist_admin
                                ? 'flex-start'
                                : 'flex-end',
                              backgroundColor: m.ist_admin
                                ? '#1e3a8a'
                                : '#374151',
                              padding: '8px 12px',
                              borderRadius: '6px',
          ...
          <div className="modal-overlay">
            <div className="modal-card">
              ...
              <p className="login-subtitle" style={{ marginBottom: '20px' }}>
                Deine Nachricht wurde erfolgreich übermittelt. Wir kümmern uns
                umgehend darum!
              </p>
              <button
                onClick={() => {
