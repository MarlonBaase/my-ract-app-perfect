...
import Lf from './Lf'
import Wd from './Wd'
import Girokonto from './assetklassen/lf/Girokonto'
import Tagesgeld from './assetklassen/lf/Tagesgeld'
import Festgeld from './assetklassen/lf/Festgeld'
import Fremdwaehrung from './assetklassen/lf/Fremdwaehrung'
import Fremdwaehrung_stammdaten from './assetklassen/lf/Fremdwaehrung/Fremdwaehrung_stammdaten'
import FremdwaehrungDetail from './assetklassen//lf/Fremdwaehrung/Fremdwaehrung_stammdaten/FremdwaehrungDetail'
import Fremdwaehrung_konto from './assetklassen//lf/Fremdwaehrung/Fremdwaehrung_konto'
            ...
            <Route path="/assetklassen" element={<Assetklassen darkMode={darkMode} />}>
              <Route path="lf" element={<Lf darkMode={darkMode} />}>
                ...
                <Route path="fremdwaehrung" element={<Fremdwaehrung darkMode={darkMode} />}>
                  ...
                  <Route path="fremdwaehrung_stammdaten/:code" element={<FremdwaehrungDetail darkMode={darkMode} />} />
